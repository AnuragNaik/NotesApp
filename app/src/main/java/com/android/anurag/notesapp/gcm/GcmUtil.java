...
public class GcmUtil {
    ...
    public static final String PROPERTY_CHAT_ID = "chat_id";
        ...
        if (checkPlayServices(activity)) {
            ...
            if (TextUtils.isEmpty(regid)) {
                if (registrationTask == null)
                	if (activity instanceof com.android.anurag.notesapp.gcm.GcmListener)
                        registerInBackground((com.android.anurag.notesapp.gcm.GcmListener)activity);
                	else
